...
media.addEventListener('click', ()=>{
  ...
  med_idad.innerHTML = '    média é = ' + med_idade.toFixed(2);
varianc.innerHTML = '   variância é = ' + variancia.toFixed(2);
desv_pad.innerHTML = '  desvio padrão é = ' + desvio_padrao.toFixed(2);
})
